    ...
    return <div style={{backgroundColor:'white'}}>
        ...
        <div className="row m-0-0">
         ...
         <div className="search-main-bd">
            ...
            <div>
                <a className="categoryLinks">FoldingCartons</a>
                <a  className="categoryLinks">Packagingwith Lids</a>
                <a  className="categoryLinks">Gift Packaging</a>
                <a  className="categoryLinks">Slipcases</a>
                <a  className="categoryLinks">Pillow Boxes And Cardboard Sleeves</a>
                <a  className="categoryLinks">Food Safe Packaging</a>
            </div>
