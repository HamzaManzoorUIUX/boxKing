...
export default () => {
    ...
    const handleFinishingChange = (value) => {
        ...
        if (foundValue) {
            ...
            const amount= selectedfinishing.extraamount?selectedfinishing.extraamount:0
            setSelectedfinishing(foundValue);
            setSubTotal(parseFloat(subTotal)+parseFloat(foundValue.extraamount)-parseFloat(amount))
        }
    }
    const handleFinishingEffectChange = (value) => {
        let foundValue = finishingEffect.find(x => x.id == value);
        if (foundValue) {
            const amount= selectedfinishingEffect.extraamount?selectedfinishingEffect.extraamount:0
    ...
    const handleMaterialChange = (value) => {
        ...
        if (foundValue) {
            const amount= selectedmaterial.extraamount?selectedmaterial.extraamount:0
    ...
    const handleProcessingChange = (value) => {
        ...
        if (foundValue) {
            const amount= selectedtypeOfprocessing.extraamount?selectedtypeOfprocessing.extraamount:0
        ...
        <section class="lorem-section">
            <div class="container mt-4 mb-5">
                <div class="row">
                    ...
                    {
                        (product != null && product.hasModel == 1 ? <div class="col-md-4 p-0">
                            <div class="row">
                                <div class="col-md-12">
                                        ...
                                        <div class="card-body font-16px">
                                            ...
                                            <div class="row mt-5">
                                                <div class="col-md-12 fsdlkekss">
                                                    ...
                                                    <small class="pull-right"><b>${(product != null ? product.unitCost*quantity : "")}</b></small>
                                                </div>
                                            </div>
                                            <div class="row mt-1">
                                                <div class="col-md-12 fsdlkekss">
                                                    <small>Finishing</small>
                                                    <small class="pull-right pl-2">${(_.isEmpty(selectedfinishing) ?0: selectedfinishing.extraamount*quantity)}</small>
                                                </div>
                                            </div>
                                            <div class="row mt-1">
                                                <div class="col-md-12 fsdlkekss">
                                                    <small>Finishing Effect</small>
                                                    <small class="pull-right pl-2">${(_.isEmpty(selectedfinishingEffect) ?0: selectedfinishingEffect.extraamount*quantity)}</small>
                                                </div>
                                            </div>
                                            <div class="row mt-1">
                                                <div class="col-md-12 fsdlkekss">
                                                    <small>Material</small>
                                                    <small class="pull-right pl-2">${(_.isEmpty(selectedmaterial) ?0: selectedmaterial.extraamount*quantity)}</small>
                                                </div>
                                            </div>
                                            <div class="row mt-1">
                                                <div class="col-md-12 fsdlkekss">
                                                    <small>Processing</small>
                                                    <small class="pull-right pl-2">${(_.isEmpty(selectedtypeOfprocessing) ?0: selectedtypeOfprocessing.extraamount*quantity)}</small>
                                                </div>
                                            </div>
                                            <div class="row mt-1">
                                                <div class="col-md-12 fsdlkekss">
                                                    <small><b>Your price gross</b></small>
                    <small class="pull-right"><b class="theme-text f-20">$ {parseFloat(subTotal).toFixed(2)*quantity}</b></small>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
