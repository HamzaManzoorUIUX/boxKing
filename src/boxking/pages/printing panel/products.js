    ...
    const columns = [

        {
            ...
            return    <div className="prdDispOrdr pt-5" >
                <img style={{ width: 50, height: 50 ,marginLeft:20}} src={urlImg + "dist/img/upload/" + row.product.image} />
      ...
      }        ,
        {
            ...
            cell: (row) => <div className="tabDD">
                <Dropdown>
                    ...
                    <Dropdown.Menu>
                        <Dropdown.Item  onClick={()=>history.push({pathname: '/printing/OrderItem', state: {row}})}  >View</Dropdown.Item>
                       </Dropdown.Menu>
                </Dropdown>
            </div>
        }
